        ...
        <Container>
          ...
          <div className="mt-10 flex justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 font-display font-600 text-ink shadow-lg shadow-teal-900/5 ring-1 ring-black/[0.04] transition-transform hover:-translate-y-0.5"
            >
              <GoogleG />
